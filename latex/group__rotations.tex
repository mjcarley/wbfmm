...
gint {\bf wbfmm\+\_\+rotate\+\_\+\+H} (gdouble $\ast$Co, gint cstro, gdouble $\ast$Ci, gint cstri, gint N, gdouble $\ast$H, gdouble ph, gdouble ch)
...
\begin{DoxyCompactList}\small\item\em Compute rotation coefficients for angle $\theta$. \end{DoxyCompactList}\item 
gint {\bf wbfmm\+\_\+rotate\+\_\+\+H\+\_\+f} (gfloat $\ast$Co, gint cstro, gfloat $\ast$Ci, gint cstri, gint N, gfloat $\ast$H, gfloat ph, gfloat ch)
\begin{DoxyCompactList}\small\item\em Apply rotation $(\theta,\phi\,\chi)$ to multipole coefficients. \end{DoxyCompactList}\item 
...
\item[{gdouble}]{ch}
\end{DoxyParamCaption}
)}\label{group__rotations_ga93a893069e4a4ca08107764c1adb91f1}
...
\item[{gfloat}]{ch}
\end{DoxyParamCaption}
)}\label{group__rotations_ga3e495252419e8ac6498122d27386911e}
