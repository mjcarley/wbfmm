 ...
 * problem using FMM
 *
 * On exit, \a f is incremented according to the \a field specifier
 * and the stride \a fstr. For 
 *
 * - ::WBFMM_FIELD_SCALAR \c f[i*fstr] is the field generated by
 * component \c i of the source;
 * - ::WBFMM_FIELD_GRADIENT \c f[i*fstr+0,1,2] is the gradient of the field
 * generated by source component \c i  (\c fstr>2 if \c nq is not one);
 * - ::WBFMM_FIELD_CURL \c f[0,1,2] is the curl of the field generated by
 * the first three components of the source;
 * 
 * For convenience ::WBFMM_FIELD_SCALAR | ::WBFMM_FIELD_GRADIENT is treated
 * as identical to ::WBFMM_FIELD_GRADIENT, and likewise for ::WBFMM_FIELD_CURL
 *
...
gint wbfmm_laplace_box_field(wbfmm_tree_t *t,
				   guint level, guint b,
...
gint wbfmm_laplace_field_direct(gdouble *xs,
				      gint xstr,
				      gdouble *n,
				      gint nstr,
				      gint nsrc,
...
gint wbfmm_laplace_box_field_f(wbfmm_tree_t *t,
				   guint level, guint b,
...
gint wbfmm_laplace_field_direct_f(gfloat *xs,
				      gint xstr,
				      gfloat *n,
				      gint nstr,
				      gint nsrc,
