 ...
 * @param swt weight (scaling factor) for multiplication of entries in \a src;
 ...
 * @param dwt weight (scaling factor) for multiplication of entries in 
 * \a dipoles;
 ...
 * number of threads is determined by the CPU.
 *
