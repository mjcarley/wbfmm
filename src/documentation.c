 ...
 * Tue Aug 13 14:12:06 BST 2019
 * -------------------------------
 */


/** 
 * @fn gint wbfmm_tree_add_points(wbfmm_tree_t *t, 
 * gpointer pts,
 *  guint npts, gsize pstr)
 *
 * @ingroup boxes
 *
...
/** 
 * @fn gint wbfmm_rotation_angles(gdouble *ix,
 * gdouble *iy, gdouble *iz, gdouble *jx, gdouble *jy,
 * gdouble *jz, gdouble *th, gdouble *ph, gdouble *ch)
 *
 * @ingroup rotations
...
/**
 * @fn gint wbfmm_coefficients_H_rotation(gdouble
 * *H, gint N, gdouble th, gdouble *work)
 *
 * @ingroup rotations
...
/**
 * @fn gint wbfmm_rotate_H(gdouble *Co, gint cstro,
 * gint N, gdouble *Ci, gint cstri, gdouble *H, gdouble ph,
 * gdouble ch)
 *
 * @ingroup rotations
...
/**
 * @fn gint wbfmm_coefficients_SR_coaxial(gdouble *cfftSR, 
 * gint L, gdouble kr,  gdouble *work)
 *
 * @ingroup translations
 *
...
/**
 * @fn gint wbfmm_coaxial_translate(gdouble *Co,
 * gint cstro, gint No, gdouble *Ci, gint cstri, gint Ni,
 * gdouble *cfft, gint L, gboolean complex)
 *
 * @ingroup translations
 *
...
/**
 * @fn wbfmm_tree_t *wbfmm_tree_new(gdouble *x,
 * gdouble D, guint maxpoints)
 *
 * @ingroup boxes
 *
...
/**
 * @fn gint wbfmm_tree_leaf_expansions(wbfmm_tree_t *t,
 * gdouble k, gdouble *src, gint sstr, 
...
/**
 * @fn gint wbfmm_tree_box_field(wbfmm_tree_t *t, guint
 * level, guint b, gdouble k, gdouble *x, gdouble *f,
 * gdouble *work)
 *
 * @ingroup boxes
 *
...
/**
 * @fn gint wbfmm_tree_box_local_field(wbfmm_tree_t *t,
...
/**
 * @fn guint64 wbfmm_point_index_3d(gdouble *x,
 * gdouble *c, gdouble D)
 *
 * @ingroup boxes
 *
...
/**
 * @fn gint wbfmm_tree_coefficient_init(wbfmm_tree_t
 * *t, guint l, guint nr, guint ns)
 *
 * @ingroup boxes 
 *
...
/** 
 * @fn gint wbfmm_tree_refine(wbfmm_tree_t *t)
 *
 * @ingroup boxes
 *
 * @brief
...
/**
 * @fn gint wbfmm_child_parent_shift(gdouble *Cp, gint Np,
					     gdouble *Cc, gint Nc,
					     gdouble *H03, 
					     gdouble *H47, gint Lh,
...
/**
 * @fn gint wbfmm_parent_child_shift(gdouble *Cc, gint Nc,
					     gdouble *Cp, gint Np,
					     gdouble *H03, 
					     gdouble *H47, gint Lh,
					     gdouble *trans, gint Ls,
...
/**
 * @fn gint wbfmm_shift_angles_list4(gint i, gint j, gint k,
...
/**
 * @fn gint wbfmm_shift_angle_table_init(void)
 *
 * @ingroup shift
 *
...
/**
 * @fn wbfmm_shift_operators_t *wbfmm_shift_operators_new(guint L, gdouble *work)
...
/**
 * @fn gint wbfmm_shift_operators_coaxial_SR_init)
...
/**
 * @fn gint wbfmm_shift_operators_coaxial_SS_init)
...
/**
 * @fn gint wbfmm_expansion_h_cfft(gdouble k, gint N, 
                                                  gdouble *x0,
						  gdouble *xs,
						  gdouble *q, 
...
/**
 * @fn gint wbfmm_expansion_dipole_h_cfft(gdouble k, gint N, 
						  gdouble *x0,
						  gdouble *xs,
						  gdouble *fx,
						  gdouble *fy,
...
/**
 * @fn gint wbfmm_expansion_h_evaluate(gdouble k, 
                                                      gdouble *x0,
						      gdouble *cfft,
						      gint cstr,
						      gint N, 
...
/**
 * @fn gint wbfmm_expansion_j_evaluate(gdouble k,
                                                      gdouble *x0,
						      gdouble *cfft,
						      gint cstr,
						      gint N, 
...
/**
 * @fn gint wbfmm_downward_pass(wbfmm_tree_t *t,
...
/**
 * @fn gint wbfmm_upward_pass(wbfmm_tree_t *t,
				      wbfmm_shift_operators_t *op,
				      guint level, gdouble *work)
 *
 * @ingroup pass
...
/**
 * @fn gint wbfmm_cartesian_to_spherical(gdouble
						 *x0, gdouble *x,
						 gdouble *r,
						 gdouble *th,
						 gdouble *ph)
...
/**
 * @fn gint wbfmm_legendre_recursion_array(gdouble **Pnm1,
						   gdouble **Pn, gint n,
						   gdouble C, gdouble S)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_legendre_init(gdouble C, gdouble S, 
...
/**
 * @fn gint wbfmm_bessel_j_recursion(gdouble *jnm1,
					     gdouble *jn,
					     gdouble x, gint n)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_bessel_j_init(gdouble x,
...
/**
 * @fn gint wbfmm_bessel_h_init(gdouble x,
					gdouble *h0, gdouble *h1)
 *
 * @ingroup util
 *
...
/**
 * @fn gint wbfmm_bessel_h_recursion(gdouble *hnm1,
					     gdouble *hn,
					     gdouble x, gint n)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_total_dipole_field(gdouble k,
...
/**
 * @fn gint wbfmm_total_field(gdouble k, gdouble
...
/**
 * @fn gint wbfmm_coordinate_transform(gdouble *x,
					       gdouble *ix,
					       gdouble *iy,
					       gdouble *iz,
					       gdouble *y)
...
/**
 * @fn gint wbfmm_shift_coordinates(gdouble *x, gdouble *y,
...
/**
 * @fn gint wbfmm_box_location_from_index(guint64 idx,
						  guint32 level,
						  gdouble *x0,
						  gdouble D,
						  gdouble *x,
...
/**
 * @fn gint wbfmm_tree_box_centre(wbfmm_tree_t *t, guint32 level,
...
/**
 * @fn gint wbfmm_points_origin_width(gdouble *x,
					     gint str, gint n,
					     gdouble *xmin,
					     gdouble *D,
...
/**
 * @fn gint wbfmm_shift_angles(gdouble *xi, gdouble *xj,
				       gdouble *th, gdouble *ph,
...
/**
 * @fn gint wbfmm_tree_write_sources(wbfmm_tree_t *t,
...
/**
 * @fn gint wbfmm_expansion_laplace_cfft(gint N,
						       gdouble *x0,
						       gdouble *xs,
						       gdouble *q, gint nq,
						       gdouble *cfft,
...
/**
 * @fn gint wbfmm_expansion_laplace_evaluate(gdouble *x0,
  gdouble *cfft, gint cstr, gint nq, gint N, gdouble *xf,
  gdouble *field, gdouble *work)
 *
 * @ingroup laplace
 *
 ...
 */
/** 
 * @fn gint wbfmm_tree_add_points_f(wbfmm_tree_t *t, 
 * gpointer pts,
 *  guint npts, gsize pstr)
 *
 * @ingroup boxes
...
/** 
 * @fn gint wbfmm_rotation_angles_f(gfloat *ix,
 * gfloat *iy, gfloat *iz, gfloat *jx, gfloat *jy,
 * gfloat *jz, gfloat *th, gfloat *ph, gfloat *ch)
 *
 * @ingroup rotations
 * @brief Compute the rotation angles \f$(\theta,\phi,\chi)\f$ between axes
 *
...
/**
 * @fn gint wbfmm_coefficients_H_rotation_f(gfloat
 * *H, gint N, gfloat th, gfloat *work)
 *
 * @ingroup rotations
 * @brief Compute rotation coefficients for angle \f$\theta\f$
 *
...
/**
 * @fn gint wbfmm_rotate_H_f(gfloat *Co, gint cstro,
 * gint N, gfloat *Ci, gint cstri, gfloat *H, gfloat ph,
 * gfloat ch)
 *
 * @ingroup rotations
 * @brief Apply rotation \f$(\theta,\phi\,\chi)\f$ to multipole
...
/**
 * @fn gint wbfmm_coefficients_SR_coaxial_f(gfloat *cfftSR, 
 * gint L, gfloat kr,  gfloat *work)
 *
 * @ingroup translations
 *
 * @brief Generate coefficients for coaxial singular-to-regular translation
...
/**
 * @fn gint wbfmm_coaxial_translate_f(gfloat *Co,
 * gint cstro, gint No, gfloat *Ci, gint cstri, gint Ni,
 * gfloat *cfft, gint L, gboolean complex)
 *
 * @ingroup translations
 *
 * @brief Perform coaxial translation of multipole expansion
...
/**
 * @fn wbfmm_tree_t *wbfmm_tree_new_f(gfloat *x,
 * gfloat D, guint maxpoints)
 *
 * @ingroup boxes
 *
 * @brief Allocate a new octree
...
/**
 * @fn gint wbfmm_tree_leaf_expansions_f(wbfmm_tree_t *t,
 * gfloat k, gfloat *src, gint sstr, 
...
/**
 * @fn gint wbfmm_tree_box_field_f(wbfmm_tree_t *t, guint
 * level, guint b, gfloat k, gfloat *x, gfloat *f,
 * gfloat *work)
 *
 * @ingroup boxes
 *
...
/**
 * @fn gint wbfmm_tree_box_local_field_f(wbfmm_tree_t *t,
...
/**
 * @fn guint64 wbfmm_point_index_3d_f(gfloat *x,
 * gfloat *c, gfloat D)
 *
 * @ingroup boxes
 *
...
/**
 * @fn gint wbfmm_tree_coefficient_init_f(wbfmm_tree_t
 * *t, guint l, guint nr, guint ns)
 *
 * @ingroup boxes 
 *
...
/** 
 * @fn gint wbfmm_tree_refine_f(wbfmm_tree_t *t)
 *
 * @ingroup boxes
 *
 * @brief
...
/**
 * @fn gint wbfmm_child_parent_shift_f(gfloat *Cp, gint Np,
					     gfloat *Cc, gint Nc,
					     gfloat *H03, 
					     gfloat *H47, gint Lh,
...
/**
 * @fn gint wbfmm_parent_child_shift_f(gfloat *Cc, gint Nc,
					     gfloat *Cp, gint Np,
					     gfloat *H03, 
					     gfloat *H47, gint Lh,
					     gfloat *trans, gint Ls,
...
/**
 * @fn gint wbfmm_shift_angles_list4_f(gint i, gint j, gint k,
					     gfloat *th, gfloat *ph,
					     gfloat *ch, gfloat *rs)
 *
 * @ingroup shift
...
/**
 * @fn gint wbfmm_shift_angle_table_init_f(void)
 *
 * @ingroup shift
 *
 * @brief Initialize table of angles for shift operations
...
/**
 * @fn wbfmm_shift_operators_t *wbfmm_shift_operators_new_f(guint L, gfloat *work)
...
/**
 * @fn gint wbfmm_expansion_h_cfft_f(gfloat k, gint N, 
                                                  gfloat *x0,
						  gfloat *xs,
						  gfloat *q, 
...
/**
 * @fn gint wbfmm_expansion_dipole_h_cfft_f(gfloat k, gint N, 
						  gfloat *x0,
						  gfloat *xs,
						  gfloat *fx,
						  gfloat *fy,
...
/**
 * @fn gint wbfmm_expansion_h_evaluate_f(gfloat k, 
                                                      gfloat *x0,
						      gfloat *cfft,
						      gint cstr,
						      gint N, 
...
/**
 * @fn gint wbfmm_expansion_j_evaluate_f(gfloat k,
                                                      gfloat *x0,
						      gfloat *cfft,
						      gint cstr,
						      gint N, 
...
/**
 * @fn gint wbfmm_downward_pass_f(wbfmm_tree_t *t,
					wbfmm_shift_operators_t *op,
...
/**
 * @fn gint wbfmm_upward_pass_f(wbfmm_tree_t *t,
				      wbfmm_shift_operators_t *op,
				      guint level, gfloat *work)
 *
 * @ingroup pass
...
/**
 * @fn gint wbfmm_cartesian_to_spherical_f(gfloat
						 *x0, gfloat *x,
						 gfloat *r,
						 gfloat *th,
						 gfloat *ph)
...
/**
 * @fn gint wbfmm_legendre_recursion_array_f(gfloat **Pnm1,
						   gfloat **Pn, gint n,
						   gfloat C, gfloat S)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_legendre_init_f(gfloat C, gfloat S, 
...
/**
 * @fn gint wbfmm_bessel_j_recursion_f(gfloat *jnm1,
					     gfloat *jn,
					     gfloat x, gint n)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_bessel_j_init_f(gfloat x,
					gfloat *j0, gfloat *j1)
 *
 * @ingroup util
 *
...
/**
 * @fn gint wbfmm_bessel_h_init_f(gfloat x,
					gfloat *h0, gfloat *h1)
 *
 * @ingroup util
 *
...
/**
 * @fn gint wbfmm_bessel_h_recursion_f(gfloat *hnm1,
					     gfloat *hn,
					     gfloat x, gint n)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_total_dipole_field_f(gfloat k,
...
/**
 * @fn gint wbfmm_total_field_f(gfloat k, gfloat
...
/**
 * @fn gint wbfmm_coordinate_transform_f(gfloat *x,
					       gfloat *ix,
					       gfloat *iy,
					       gfloat *iz,
					       gfloat *y)
...
/**
 * @fn gint wbfmm_shift_coordinates_f(gfloat *x, gfloat *y,
					    gfloat *ix, gfloat *iy,
					    gfloat *iz,
					    gfloat *r)
 *
...
/**
 * @fn gint wbfmm_box_location_from_index_f(guint64 idx,
						  guint32 level,
						  gfloat *x0,
						  gfloat D,
						  gfloat *x,
...
/**
 * @fn gint wbfmm_tree_box_centre_f(wbfmm_tree_t *t, guint32 level,
					  guint64 b, gfloat *xb,
					  gfloat *wb)
 *
 * @ingroup util
...
/**
 * @fn gint wbfmm_points_origin_width_f(gfloat *x,
					     gint str, gint n,
					     gfloat *xmin,
					     gfloat *D,
					     gboolean init_limits)
...
/**
 * @fn gint wbfmm_shift_angles_f(gfloat *xi, gfloat *xj,
				       gfloat *th, gfloat *ph,
				       gfloat *ch, gfloat *r)
...
/**
 * @fn gint wbfmm_tree_write_sources_f(wbfmm_tree_t *t,
...
/**
 * @fn gint wbfmm_expansion_laplace_cfft_f(gint N,
						       gfloat *x0,
						       gfloat *xs,
						       gfloat *q, gint nq,
						       gfloat *cfft,
...
/**
 * @fn gint wbfmm_expansion_laplace_evaluate_f(gfloat *x0,
  gfloat *cfft, gint cstr, gint nq, gint N, gfloat *xf,
  gfloat *field, gfloat *work)
 *
 * @ingroup laplace
 *
 * @brief Evaluate a singular expansion for Laplace problem
