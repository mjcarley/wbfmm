 ...
 *
 * - ::WBFMM_FIELD_POTENTIAL \c f[i*fstr] is the field generated by
 ...
 * - ::WBFMM_FIELD_CURL | ::WBFMM_FIELD_GRADIENT the first three components
 * of \c f are the curl of the field from the first three components, and
 * the following nine components are the derivatives of the curl with respect
 * \f$x\f$, \f$y\f$, \f$z\f$.
 * 
 * For convenience ::WBFMM_FIELD_POTENTIAL | ::WBFMM_FIELD_GRADIENT is treated
 ...
 * boxes neighbouring \a b (this should always be TRUE, except for certain
