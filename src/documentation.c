 ...
 * gdouble k, gdouble *src, gint sstr, gboolean zero_expansions,
 * gdouble *work)
 *
 * @ingroup boxes
 *
 ...
 * @param zero_expansions if TRUE, set local expansions to zero before
 * adding source terms;
 * @param work workspace.
 *
 * @return 0 on success
...
/** 
 * @fn wbfmm_tree_add_points(wbfmm_tree_t *t, gpointer
 * pts, guint npts, gsize pstr)
 *
 * @ingroup boxes
 *
 ...
 * gfloat k, gfloat *src, gint sstr, gboolean zero_expansions,
 * gfloat *work)
 *
 * @ingroup boxes
 *
...
/** 
 * @fn wbfmm_tree_add_points_f(wbfmm_tree_t *t, gpointer
 * pts, guint npts, gsize pstr)
 *
 * @ingroup boxes
 *
