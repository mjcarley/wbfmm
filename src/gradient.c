		       ...
		       
{
  ...
  n = 0 ; 
  m = 0 ; 
  expansion_j_grad_increment(n, m,  1, jnm1, cfft, cstr, 
			    Pnm1, Cmph[m], Smph[m], field) ;

  n = 1 ; 
  m = 0 ; 
  expansion_j_grad_increment(n, m,  1, jn, cfft, cstr, Pn, Cmph[m], Smph[m], field) ;
  ...
  for ( n = 2 ; n <= N ; n ++ ) {
    ...
    m = 0 ; 
    expansion_j_grad_increment(n, m,  1, jn, cfft, cstr, 
