...
gint WBFMM_FUNCTION_NAME(wbfmm_coefficients_SR_coaxial)(WBFMM_REAL *cfftSR, gint L,
						  WBFMM_REAL kr, 
						  WBFMM_REAL *work)
...
gint WBFMM_FUNCTION_NAME(wbfmm_coaxial_translate_ref)(WBFMM_REAL *Co, gint cstro, 
						gint No,
