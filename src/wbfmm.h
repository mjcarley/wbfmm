...
gint wbfmm_box_fields_laplace_f(wbfmm_tree_t *t,
				...
				gfloat *field,
				gfloat *work) ;
gint wbfmm_tree_box_laplace_local_field(wbfmm_tree_t *t,
					guint level,
					guint b,
					gdouble *x,
					gdouble *f,
					...
					gdouble *work) ;
gint wbfmm_tree_box_laplace_local_field_f(wbfmm_tree_t *t,
					  guint level,
					  guint b,
					  gfloat *x,
					  gfloat *f,
...
#define wbfmm_coaxial_translate_f(_Co,_cstro,_No,_Ci,_cstri,_Ni,_cft,_L,_c) \
  wbfmm_coaxial_translate_ref_f(_Co,_cstro,_No,_Ci,_cstri,_Ni,_cft,_L,_c)
