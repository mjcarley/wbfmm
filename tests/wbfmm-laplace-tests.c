...

{
  ...
  /*check pre-computed evaluation method*/
  xf[0] -= x0[0] ; xf[1] -= x0[1] ; xf[2] -= x0[2] ; 
  wbfmm_laplace_local_coefficients(xf, N1, FALSE, eval, work) ;
  wbfmm_laplace_expansion_apply(Cr, cstr, nq, eval, N1, fe) ;
...

{
  ...
  __attribute__ ((aligned (32))) gdouble Ci[BUFSIZE] = {0.0},
    Co[BUFSIZE] = {0.0}, Cc[BUFSIZE] = {0.0} ;
  gdouble fc[8]={0.0}, ff[8]={0.0}, fr[8]={0.0} ;
