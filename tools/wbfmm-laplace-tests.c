...
gint local_gradient_test(gint N, gdouble *x0, gdouble *xs,
			 gint xstride, gdouble *src, gint sstride,
			 gint nsrc, gdouble *xf, gint nfld, gdouble t) ;
gint local_laplacian_test(gint N, gdouble *x0, gdouble *xs,
			  gint xstride, gdouble *src, gint sstride,
			  gint nsrc, gdouble *xf, gint nfld, gdouble t) ;
gint local_curl_gradient_test(gint N, gdouble *x0, gdouble *xs,
			      gint xstride, gdouble *src, gint sstride,
			      gint nsrc, gdouble *xf, gint nfld,
			      gdouble t) ;
gint local_curl_test(gint N, gdouble *x0, gdouble *xs,
		     gint xstride, gdouble *src, gint sstride,
		     gint nsrc, gdouble *xf, gint nfld,
		     gdouble t) ;
...

{
  ...
  wbfmm_laplace_expansion_local_eval(xp, Cp, 8*nq, Np, nq,
					   WBFMM_FIELD_SCALAR,
					   xe, fp, 1, work) ;
  ...
  wbfmm_laplace_expansion_local_eval(xc, crr, nq, Nc, nq,
					   WBFMM_FIELD_SCALAR,
					   xe, fs, 1, work) ;
  ...
  wbfmm_laplace_expansion_local_eval(xc, &(Cc[quad*nq]), 8*nq,
					   Nc, nq,
					   WBFMM_FIELD_SCALAR,
					   xe, fc, 1, work) ;
  wbfmm_laplace_field(xs, xstride, src, sstride, nq, NULL, 0, NULL, 0,
...

{
  ...
  /*reference calculation*/
  wbfmm_laplace_field_laplacian(xs, xstride, src, sstride, nq,
				      NULL, 0, NULL, 0, nsrc, xf, fc, fstr) ;
  ...
  x0[2] += t ;
  wbfmm_laplace_expansion_local_laplacian_evaluate(x0, Co, cstr, Nr, nq,
							 xf, ft, fstr, work) ;
